...
class RecursionInit0 extends DataClass implements CSProcess {
			...
			for (int i = 0; i < nProcesses; i = i + splitCount) {
				if (depth == 0) { //initial RP
					...
					for (int j = 0; j < splitCount; ++j) {						
						def rp = new RecursiveProcess0(lDetails: lDetails,
													  workMethod1: workMethod,
													  dataSet: dataset,
													  depth: depth,
													  splitCount: splitCount,
