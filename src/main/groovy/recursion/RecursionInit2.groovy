...
class RecursionInit2 extends DataClass implements CSProcess {
				...
				if (depth == 0) { //initial RP					
					def rp = new RecursiveProcess2(
											       	...
											       	splitCount: splitCount,
												   		...
												   		parameters: dataset == [] ? lDetails.lInitData : [dataset, lDetails.lInitData],
												   //channels
					...
					for (int j = 0; j < splitCount; ++j) {						
						def rp = new RecursiveProcess2(lDetails: lDetails,
													   workMethod1: workMethod1,
													   workMethod2: workMethod2 == "" ? "" : workMethod2,
													   parameters: dataset == [] ? lDetails.lInitData : [dataset, lDetails.lInitData],
													   depth: depth,
